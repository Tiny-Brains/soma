-- The CTE block below is `sql/soma-clock-pair-run-demand.sql`'s, verbatim, with a different
-- final SELECT. `scripts/check-sql.sh` diffs them: a change to one is a change to both.
--
