...
PAIRS = [("k_reap", "soma-clock-reap-run", "reap"), ("k_claim", "soma-gate-claim", "claim"),
         ...
         ("p_demand_doc", "soma-clock-pair-run", "demand"), ("p_trials", "soma-clock-pair-run", "trials"),
         ("p_insert", "soma-clock-pair-run", "insert"), ("w_sweep", "soma-clock-withdraw-run", "sweep"),
         ("n_version", "soma-clock-count-run", "notify_promoted"),
         ("n_version", "soma-clock-count-run", "notify_rejected"),
         ("n_version", "soma-clock-admit-run", "notify"),
         ("n_expired", "soma-clock-admit-run", "notify_expired"),
         ...
         ("g_admit_claim", "soma-gate-admissions-claim", "claim"),
         ("g_admit_row", "soma-gate-admissions-claim", "row"),
